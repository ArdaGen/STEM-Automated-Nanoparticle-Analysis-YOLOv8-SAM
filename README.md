...
- Demo movie from an Intel Core i7 system with 64 GB RAM and an NVIDIA RTX 4060 Ti (16 GB)
- nanoDetect supports CPU-only execution, although with reduced processing speed compared to GPU acceleration.
